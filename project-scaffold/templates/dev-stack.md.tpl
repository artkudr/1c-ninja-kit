...
| bsl-analyzer | лаунчер `%LOCALAPPDATA%\bsl-analyzer`; кеш `<проект>\.build` | MCP workspace (project) |
| 1c-mcp-toolkit | `http://127.0.0.1:6003/mcp` | fallback; EPF: `C:\1C\soft\MCP_Toolkit.epf` |
