...
# present; mode always deny (no .v8-project).
# Never throws (except sys.exit on deny) — errors degrade to allow.
# ============================================================
...
def assert_edit_allowed(target_path, require):
    try:
        ...
        off_note = "Чтобы править объект на поддержке: снять с поддержки через /support-edit или не трогать объект на замке."
