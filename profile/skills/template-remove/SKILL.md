...
```powershell
powershell.exe -NoProfile -File "%USERPROFILE%\.cursor\skills\template-remove\scripts/remove-template.ps1" -ObjectName "<ObjectName>" -TemplateName "<TemplateName>" [-SrcDir "<SrcDir>"]
```
