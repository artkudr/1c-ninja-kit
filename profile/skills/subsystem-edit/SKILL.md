...
```powershell
powershell.exe -NoProfile -File "%USERPROFILE%\.cursor\skills\subsystem-edit\scripts/subsystem-edit.ps1" -SubsystemPath '<path>' -Operation add-content -Value 'Catalog.Товары'
```
