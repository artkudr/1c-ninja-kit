...
| SrcDir        | нет          | `src/epf`             | Корзина исходников (nested)                |
...
1. Найди и прочитай `ObjectModule.bsl` через Glob: `src/epf/{{ProcessorName}}/{{ProcessorName}}/Ext/ObjectModule.bsl`
...
5. Добавь обработчик:
   ...
   - Для клиентских обработчиков — в модуль формы (найти через Glob: `src/epf/{{ProcessorName}}/{{ProcessorName}}/Forms/*/Ext/Form/Module.bsl`)
